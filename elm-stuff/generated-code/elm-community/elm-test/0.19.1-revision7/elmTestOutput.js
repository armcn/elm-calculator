...
var $author$project$Main$Percentage = {$: 'Percentage'};
var $author$project$Main$PlusMinus = {$: 'PlusMinus'};
...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{
			append: false,
			button: A2($author$project$Main$Button, '', false),
			cleared: true,
			currentValue: '0',
			decimal: false,
			inputs: _List_Nil,
			...
			result: 0,
			screenSize: A2($author$project$Main$ScreenSize, flags.width, flags.height)
		},
...
var $author$project$Main$inputOperation = F3(
	function (id, operation, model) {
		return ((!model.cleared) && model.lastValueNumber) ? _Utils_update(
			model,
			{
				append: false,
				currentValue: '',
				...
				inputs: A2(
					...
					_List_fromArray(
						[id])),
				lastValue: $elm$core$String$fromFloat(model.result),
				lastValueNumber: false,
				operation: operation
			}) : model;
	});
var $author$project$Main$addOperation = A2($author$project$Main$inputOperation, '+', $author$project$Main$add);
...
var $author$project$Main$decimal = function (model) {
	return A2($elm$core$String$contains, '.', model.currentValue) ? model : _Utils_update(
		model,
		{append: true, decimal: true});
};
var $author$project$Main$divide = F2(
	function (x, y) {
		return x / y;
	});
var $author$project$Main$divideOperation = A2($author$project$Main$inputOperation, '/', $author$project$Main$divide);
var $author$project$Main$equal = function (model) {
	return model.cleared ? model : _Utils_update(
		model,
		{
			append: false,
			currentValue: $elm$core$String$fromFloat(model.result),
...
var $author$project$Main$multiplyOperation = A2($author$project$Main$inputOperation, 'x', $author$project$Main$multiply);
var $author$project$Main$calculate = function (model) {
	return A2(
		model.operation,
		$author$project$Main$parseFloat(model.lastValue),
		$author$project$Main$parseFloat(model.currentValue));
};
var $author$project$Main$replaceLast = F2(
	function (val, list) {
		if (!list.b) {
			return A2(
				$elm$core$List$append,
			...
			return A2(
				...
				F2(
					function (index, item) {
						return _Utils_eq(
							index,
							$elm$core$List$length(list) - 1) ? val : item;
					}),
				list);
		}
	});
var $author$project$Main$percentage = function (model) {
	if (model.cleared) {
		return model;
	} else {
		var currentValue = $elm$core$String$fromFloat(
			$author$project$Main$parseFloat(model.currentValue) / 100);
		var newModel = _Utils_update(
			model,
			{
				currentValue: currentValue,
				inputs: A2($author$project$Main$replaceLast, currentValue, model.inputs)
			});
		return _Utils_update(
			newModel,
			{
				result: $author$project$Main$calculate(newModel)
			});
	}
};
var $author$project$Main$plusMinus = function (model) {
	if (model.cleared) {
		return model;
	} else {
		var currentValue = $elm$core$String$fromFloat(
			$author$project$Main$parseFloat(model.currentValue) * (-1));
		var newModel = _Utils_update(
			model,
			{
				currentValue: currentValue,
...
var $author$project$Main$pressButton = F2(
	function (model, text) {
		return _Utils_update(
			model,
			{
				button: A2($author$project$Main$Button, text, true)
			});
	});
var $author$project$Main$setScreenSize = F3(
	function (model, width, height) {
		return _Utils_update(
			model,
			{
				screenSize: A2($author$project$Main$ScreenSize, width, height)
			});
	});
...
var $author$project$Main$subtractOperation = A2($author$project$Main$inputOperation, '-', $author$project$Main$subtract);
var $author$project$Main$unpressButton = F2(
	function (model, text) {
		return _Utils_update(
			model,
			{
				button: A2($author$project$Main$Button, text, false)
			});
	});
var $author$project$Main$updateCurrentValue = F2(
	function (model, number) {
		var newModel = function () {
			if (model.append) {
				var currentValue = model.decimal ? $elm$core$String$concat(
					_List_fromArray(
						[
							model.currentValue,
							'.',
							$elm$core$String$fromInt(number)
						])) : ((model.currentValue === '0') ? '0' : A2(
				...
				if (model.lastValueNumber) {
					var currentValue = $elm$core$String$fromInt(number);
					return _Utils_update(
						model,
						{
							append: true,
					...
					return _Utils_update(
						model,
						{
							append: true,
							cleared: false,
							currentValue: $elm$core$String$fromInt(number),
							inputs: A2(
								$elm$core$List$append,
								model.inputs,
								_List_fromArray(
		...
		var result = $author$project$Main$calculate(newModel);
		return _Utils_update(
			newModel,
			{lastValueNumber: true, result: result});
	});
			...
			function () {
				switch (msg.$) {
					case 'SetScreenSize':
						var width = msg.a;
						var height = msg.b;
						return A3($author$project$Main$setScreenSize, model, width, height);
					case 'PressButton':
						var text = msg.a;
						return A2($author$project$Main$pressButton, model, text);
					case 'UnpressButton':
						var text = msg.a;
						return A2($author$project$Main$unpressButton, model, text);
					case 'Number':
						var number = msg.a;
						return A2($author$project$Main$updateCurrentValue, model, number);
					case 'Add':
						return $author$project$Main$addOperation(model);
					case 'Subtract':
						return $author$project$Main$subtractOperation(model);
					case 'Multiply':
						return $author$project$Main$multiplyOperation(model);
					case 'Divide':
						return $author$project$Main$divideOperation(model);
					case 'Decimal':
						return $author$project$Main$decimal(model);
					case 'Percentage':
						return $author$project$Main$percentage(model);
					case 'PlusMinus':
						return $author$project$Main$plusMinus(model);
					case 'Equals':
						return $author$project$Main$equal(model);
					default:
						return $author$project$Main$clear(model);
				}
			}(),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Tests$suite = function () {
	var updateModel = F2(
		function (msg, model) {
			return A2($author$project$Main$update, msg, model).a;
		});
	var symbol = $elm_explorations$test$Fuzz$oneOf(
		_List_fromArray(
			[
				$elm_explorations$test$Fuzz$constant($author$project$Main$Add),
				$elm_explorations$test$Fuzz$constant($author$project$Main$Subtract),
				$elm_explorations$test$Fuzz$constant($author$project$Main$Divide),
				$elm_explorations$test$Fuzz$constant($author$project$Main$Multiply),
				$elm_explorations$test$Fuzz$constant($author$project$Main$Clear),
				$elm_explorations$test$Fuzz$constant($author$project$Main$PlusMinus),
				$elm_explorations$test$Fuzz$constant($author$project$Main$Percentage),
				$elm_explorations$test$Fuzz$constant($author$project$Main$Equals),
				$elm_explorations$test$Fuzz$constant($author$project$Main$Decimal)
			]));
	var screenState = function (model) {
		return {inputs: model.inputs, result: model.result};
	};
	var nonZeroButton = A2($elm_explorations$test$Fuzz$intRange, 1, 9);
	var initModel = $author$project$Main$init(
		A2($author$project$Main$Flags, 1, 1)).a;
	var button = A2($elm_explorations$test$Fuzz$intRange, 0, 9);
	return A2(
					...
					[
						...
						function (_v0) {
							return A2(
								...
								{
									inputs: $elm$core$List$singleton('0'),
									result: 0
								},
								screenState(
									A2(
						...
						function (a) {
							return A2(
								$elm_explorations$test$Expect$equal,
								{
									inputs: $elm$core$List$singleton(
						...
						function (a) {
							return A2(
								$elm_explorations$test$Expect$equal,
								{inputs: _List_Nil, result: 0},
								screenState(
									A2(updateModel, a, initModel)));
						}),
						A4(
						...
						F2(
							function (a, b) {
								...
								return A2(
									$elm_explorations$test$Expect$equal,
									{
										inputs: $elm$core$List$singleton(resultString),
										result: $author$project$Main$parseFloat(resultString)
									},
									screenState(
										A2(
											updateModel,
											$author$project$Main$Number(b),
											A2(
												updateModel,
												$author$project$Main$Number(a),
												initModel))));
						...
						F3(
							function (a, b, c) {
								var resultString = $elm$core$String$concat(
									_List_fromArray(
										[
											$elm$core$String$fromInt(a),
											'.',
							...
							return A2(
								...
								screenState(
									A2(
										updateModel,
										$author$project$Main$Number(a),
										A2(updateModel, $author$project$Main$Decimal, initModel))));
						}),
						A4(
						$elm_explorations$test$Test$fuzz2,
						button,
						...
						$elm_explorations$test$Test$fuzz,
						symbol,
						'symbol before any numbers does nothing',
						function (a) {
							return A2(
								$elm_explorations$test$Expect$equal,
								{inputs: _List_Nil, result: 0},
						...
						function (a) {
							var resultString = $elm$core$String$fromInt(a * (-1));
							return A2(
								$elm_explorations$test$Expect$equal,
								{
									inputs: $elm$core$List$singleton(resultString),
						...
						function (a) {
							var resultString = $elm$core$String$fromInt(a);
							return A2(
								$elm_explorations$test$Expect$equal,
								{
									inputs: $elm$core$List$singleton(resultString),
								...
								screenState(
									A2(
										...
										A2(
											updateModel,
											$author$project$Main$Number(a * (-1)),
											initModel))));
						}),
						A3(
						$elm_explorations$test$Test$fuzz,
						...
						function (a) {
							var resultString = $elm$core$String$fromFloat(a / 100);
							return A2(
								$elm_explorations$test$Expect$equal,
								{
									inputs: $elm$core$List$singleton(resultString),
								...
								screenState(
									A2(
										updateModel,
										$author$project$Main$Percentage,
										A2(
											updateModel,
											$author$project$Main$Number(a),
											initModel))));
						...
						A2(
						$elm_explorations$test$Test$test,
						'chain of inputs produces correct screen state',
						function (_v4) {
							return A2(
								$elm_explorations$test$Expect$equal,
								{
...
var pipeFilename = "/tmp/elm_test-43001.sock";
var net = require('net'),
